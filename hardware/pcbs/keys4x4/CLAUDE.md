...
- `connections.md` — JST-PH pinout, NeoPixel chain
- `architecture.md` — MCP23017 matrix, key mapping, NeoPixel daisy-chain
...
- `docs/hardware.md` — system-level hardware (beyond what's needed here)
